Summary:    Big data R packages (RHadoop, SparkR, RHIPE) with Rstat/3.1.3
Name:       big-data-r
Version:    3.1.3
Release:    1 
License:    GPLv2
...
Packager:   TACC - rhuang@tacc.utexas.edu
...
echo "LD_LIBRARY_PATH=${PROTOBUF_HOME}/lib" >> ${TACC_R_DIR}/lib64/R/etc/Renviron
...
help(
[[
This is the big data R packages built on May 01, 2015 wth Rstat/3.1.3.
...
always_load("Rstats/3.1.3")

--
-- Create environment variables.
--
-- set variable
local big_data_r_dir   = "/opt/apps/intel15/mvapich2_2_1/big-data-r/3.1.3"
...
local pkg_config_path = "${PROTOBUF_HOME}/lib/pkgconfig"
local rhipe_hadoop_tmp_folder = "/tmp"

-- bin or executable
local java_bin="/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.75.x86_64/bin"
local scala_bin="/opt/apps/intel15/mvapich2_2_1/big-data-r/3.1.3/scala-2.10.4/bin"
local spark_submit_dir = "/opt/apps/intel15/mvapich2_2_1/big-data-r/3.1.3/r-library/SparkR"
local protobuf_bin = "/opt/apps/intel15/mvapich2_2_1/big-data-r/3.1.3/protobuf-2.5.0/bin"

--  LD_LIBRARY_PATH
local protobuf_lib = "/opt/apps/intel15/mvapich2_2_1/big-data-r/3.1.3/protobuf-2.5.0/lib"
